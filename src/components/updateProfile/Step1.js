...
const Step1 = ({ navigation }) => {
    ...
    <>
      <View style={styles.titleContainer}>
        <View style={styles.title}>
          <Icon name='ruler-vertical' color={colors.primary} style = {{width: scale(20)}} size={scale(20)} />
  ...
  const weigthComponent = useMemo(() => (
    <>
      <View style={styles.titleContainer}>
        <View style={styles.title}>
          <Icon name='weight' color={colors.primary} style = {{width: scale(20)}} size={scale(20)} />
  ...
  const birthComponent = useMemo(() => (
    <>
      <View style={styles.titleContainer}>
        <View style={styles.title}>
          <Icon name='birthday-cake' color={colors.primary} style = {{width: scale(20)}} size={scale(20)} />
